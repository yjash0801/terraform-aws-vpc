...
resource "aws_nat_gateway" "mechanoidstore-ngw" {
  ...
  depends_on = [aws_internet_gateway.mechanoidstore-igw]
}
...
resource "aws_route" "public_route" {
  ...
  gateway_id = aws_internet_gateway.mechanoidstore-igw.id
}

resource "aws_route" "private_route" {
  route_table_id            = aws_route_table.private.id
  destination_cidr_block    = "0.0.0.0/0"
  nat_gateway_id = aws_nat_gateway.mechanoidstore-ngw.id
}
